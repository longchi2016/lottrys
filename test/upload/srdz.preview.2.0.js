        ...
        $this.change(function(){
            ...
            function HanderFileReader($this){
                ...
                oFReader.onload = function (oFREvent){
                    $("#" + viewid).html("<img src='"+oFREvent.target.result+"' style='width:178px;height: 158px'/>");
                    $("#" + xdelid).show();
                };
            ...
            function HanderOther($this){
                $("#" + viewid).html("<img src='"+$this.val()+"' style='width:178px;height: 158px'/>");
                $("#" + xdelid).show();
            }
